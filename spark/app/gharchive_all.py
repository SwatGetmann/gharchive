...
from commits import handle_metric_commits
from members import handle_metric_members
...
def handle_file(path):
    ...
    handle_metric_commits(spark, df, table_name="commits")
    handle_metric_members(spark, df, table_name="members")
